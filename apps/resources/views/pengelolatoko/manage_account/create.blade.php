...
<div class="container-fluid p-0">
    ...
    <h1 class="h3 mb-3"><strong>Tambah Karyawan</strong></h1>
    <hr>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" name="notelp" class="form-control" placeholder="081333344454" id="notelp" required
                    value="{{ old('notelp') }}">
            </div>
            <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-2">
                ...
                <input type="number" class="form-control" name="role" id="role" placeholder="Role" required
                    value="{{ old('role') }}">
            </div>
            <div class="form-group">
                <div class="form-group col-md-12">
                    <label for="foto" class="col-form-label"><strong>Foto:</strong></label>
                    <input type="file" value="{{ old('foto') }}" class=" form-control" name="foto" id="foto"
                        placeholder="Image URL" value="{{ old('foto') }}">
                </div>
            </div>
