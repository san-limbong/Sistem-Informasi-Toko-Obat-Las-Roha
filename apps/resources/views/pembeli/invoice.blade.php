...
<div class="card container pt-3"  style="border: none">
    <div class="alert alert-primary alert-dismissible text-center" role="alert">
        Harap menunjukkan ini pengelola toko sehingga pesanan anda dapat diproses.
...
<div class="card container" style="border: none">
    <div class="d-flex bd-highlight mb-3">
        <div class="p-2 bd-highlight"><a href="/layanan" class="btn btn-danger">Kembali</a></div>
        @foreach ($transaksi as $item)
        @endforeach
        <div class="ms-auto p-2 bd-highlight"><a href="/invoice/{{ $item->id_header_transaksi }}" class="btn btn-success">Download</a></div>
    </div>
</div>
...
<div class="card container">
    ...
    <div class="d-flex bd-highlight mb-3">
        ...
        {{-- <div class="px-2 py-4 bd-highlight">Total harga: Rp. {{ $item->totalharga }}</div> --}}
